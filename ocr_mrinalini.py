...
PDF_PATH = "data/mrinalini.pdf"
OUTPUT_FILE = "data/mrinalini_ocr.txt"
CHECKPOINT_FILE = "data/mrinalini_ocr_checkpoint.json"
...
def ocr_page(page_num, doc):
    ...
    img_path = f"/tmp/sarvam_mrinalini_{page_num}.png"
    pix.save(img_path)
    ...
    if resp.status_code == 200:
        ...
        raise RuntimeError(f"CREDITS EXHAUSTED (HTTP {resp.status_code}): {resp.text}")
    else:
