...
INPUT_FILE = "data/baeesweensadi_ocr.txt"
OUTPUT_FILE = "data/baeesweensadi_english.txt"
CHECKPOINT_FILE = "data/translate_checkpoint_v2.json"
MODEL = "gpt-4.1"
...
SYSTEM_PROMPT = (
    "You are translating a Hindi book titled 'Baeesween Sadi' (22nd Century) "
    "by Rahul Sankrityayan, a science fiction novel written in 1923. "
    "Translate the following Hindi text into fluent, literary English. "
...
def main():
    ...
    if done == total:
        print("All 121 pages translated!")
    else:
